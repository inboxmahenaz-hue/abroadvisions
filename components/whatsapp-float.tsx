...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-4 z-50 flex items-center gap-0 overflow-hidden rounded-full bg-[#25D366] py-3.5 pl-3.5 pr-3.5 text-white shadow-[0_10px_30px_rgb(37,211,102,0.45)] transition-all duration-300 hover:pr-5 sm:bottom-6 sm:right-6"
    >
      <svg
        viewBox="0 0 24 24"
